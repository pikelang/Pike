 ...
 *!
 *! @returns
 *!   An array with arrays of userinfo as in @tt{getpwent()@}
 *!
 *! @seealso
 *!   @[getpwent()]
 *!   @[getpwnam()]
...
/*! @decl int setgrent()
 *!
 *!   Rewinds the @tt{getgrent()@} pointer to the first entry
 *!
 *! @seealso
 *!   @[getgrent()]
 *!   @[endgrent()]
...
/*! @decl int endgrent()
 *!
 *!   Closes the /etc/groups file after using the @tt{getgrent()@} function.
 *!
 *! @seealso
 *!   @[getgrent()]
 *!   @[setgrent()]
