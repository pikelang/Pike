/*
 * $Id: nt.c,v 1.24 2000/08/24 12:29:57 leif Exp $
 *
...
/* Stuff for NetSessionEnum and NetWkstaUserEnum */
...
static void throw_nt_error(char *funcname, NET_API_STATUS err)
{ char *msg;
