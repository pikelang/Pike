...
|| $Id: lex.c,v 1.114 2003/08/06 18:05:27 mast Exp $
*/

#include "global.h"
RCSID("$Id: lex.c,v 1.114 2003/08/06 18:05:27 mast Exp $");
#include "language.h"
#include "array.h"
#include "lex.h"
#include "stralloc.h"
...
#define OPCODE0_TAILJUMP(OP,DESC,FLAGS) void *PIKE_CONCAT(jump_opcode_,OP)(void);
#define OPCODE1_TAILJUMP(OP,DESC,FLAGS) void *PIKE_CONCAT(jump_opcode_,OP)(INT32);
#define OPCODE2_TAILJUMP(OP,DESC,FLAGS) void *PIKE_CONCAT(jump_opcode_,OP)(INT32,INT32);
...
#define OPCODE0_TAILJUMP(OP, DESC, FLAGS) OPCODE0_TAIL(OP, DESC, FLAGS)
#define OPCODE1_TAILJUMP(OP, DESC, FLAGS) OPCODE1_TAIL(OP, DESC, FLAGS)
#define OPCODE2_TAILJUMP(OP, DESC, FLAGS) OPCODE2_TAIL(OP, DESC, FLAGS)
...
#define OPCODE0_TAILPTRJUMP(OP,DESC,FLAGS) OPCODE0_TAILJUMP(OP, DESC, FLAGS)
#define OPCODE1_TAILPTRJUMP(OP,DESC,FLAGS) OPCODE1_TAILJUMP(OP, DESC, FLAGS)
#define OPCODE2_TAILPTRJUMP(OP,DESC,FLAGS) OPCODE2_TAILJUMP(OP, DESC, FLAGS)
...
#define OPCODE0_TAILRETURN(OP,DESC,FLAGS) OPCODE0_TAILJUMP(OP, DESC, FLAGS)
#define OPCODE1_TAILRETURN(OP,DESC,FLAGS) OPCODE1_TAILJUMP(OP, DESC, FLAGS)
#define OPCODE2_TAILRETURN(OP,DESC,FLAGS) OPCODE2_TAILJUMP(OP, DESC, FLAGS)
