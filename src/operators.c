			...
			tOr6(tFuncArg(tSetvar(1, tObj),
			     ...
			     tFuncArg(tSetvar(1, tMix),
				      tFuncArg(tSetvar(2, tObj),
					       tApply(tFindLFun(tVar(2), "``/"),
						      tVar(1)))),
			     tOr5(tFunc(tInt1Plus tInt1Plus, tIntPos),
				  tFunc(tIntMinus tIntMinus, tIntPos),
				  tFunc(tInt1Plus tIntMinus, tIntNeg),
				  tFunc(tIntMinus tInt1Plus, tIntNeg),
				  tFunc(tZero tOr(tInt1Plus, tIntMinus), tZero)),
			     tOr(tFunc(tFloat tOr(tFloat, tInt), tFloat),
				 tFunc(tInt tFloat, tFloat)),
