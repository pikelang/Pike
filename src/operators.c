			...
			tOr6(tFuncArg(tSetvar(1, tObj),
			     ...
			     tFuncArg(tSetvar(1, tMix),
				      tFuncArg(tSetvar(2, tObj),
					       tApply(tFindLFun(tVar(2), "``/"),
						      tVar(1)))),
			     tOr(tFunc(tSetvar(0, tInt) tInt1Plus,
				       tOr(tRangeInt(tZero, tVar(0)),
					   tRangeInt(tVar(0), tZero))),
				 tFunc(tSetvar(0, tInt) tIntMinus,
				       tOr(tRangeInt(tZero, tNegateInt(tVar(0))),
					   tRangeInt(tNegateInt(tVar(0)), tZero)))),
			     tOr(tFunc(tFloat tOr(tFloat, tInt), tFloat),
				 tFunc(tInt tFloat, tFloat)),
