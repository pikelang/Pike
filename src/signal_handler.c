...
|| $Id: signal_handler.c,v 1.258 2003/03/25 20:26:53 nilsson Exp $
*/
...
RCSID("$Id: signal_handler.c,v 1.258 2003/03/25 20:26:53 nilsson Exp $");
...
{
#ifdef PROC_DEBUG
  fprintf(stderr, "fork: getting the lock.\n");
#endif
  mt_lock(&wait_thread_mutex);
#ifdef PROC_DEBUG
  fprintf(stderr, "fork: got the lock.\n");
#endif
}
...
#ifdef PROC_DEBUG
  fprintf(stderr, "fork: releasing the lock.\n");
#endif
