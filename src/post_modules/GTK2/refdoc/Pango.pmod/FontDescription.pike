// Automatically generated from "pangofontdescription.pre".
// Do NOT edit.
...
protected void create( void desc );
...
Pango.FontDescription merge( Pango.FontDescription desc, int replace );
