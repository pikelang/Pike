...
//! behavior : Behavior for the new dock item. One of @[GNOME_DOCK_ITEM_BEH_NEVER_VERTICAL], @[GNOME_DOCK_ITEM_BEH_NORMAL], @[GNOME_DOCK_ITEM_BEH_LOCKED], @[GNOME_DOCK_ITEM_BEH_EXCLUSIVE], @[GNOME_DOCK_ITEM_BEH_NEVER_FLOATING] and @[GNOME_DOCK_ITEM_BEH_NEVER_HORIZONTAL]
//! placement :  Placement for the new dock item, one of Gnome.DockTop,  Gnome.DockRight,  Gnome.DockBottom,  Gnome.DockLeft and  Gnome.DockFloating 
//! band_num : Number of the band where the dock item should be placed 
//! band_position : Position of the new dock item in band band_num 
//! offset : Offset from the previous dock item in the band; if there is no previous item, offset from the beginning of the band.
...
//! name : Name for the dock item that will contain toolbar
//! behavior : Behavior for the new dock item. One or more of @[GNOME_DOCK_ITEM_BEH_NEVER_VERTICAL], @[GNOME_DOCK_ITEM_BEH_NORMAL], @[GNOME_DOCK_ITEM_BEH_LOCKED], @[GNOME_DOCK_ITEM_BEH_EXCLUSIVE], @[GNOME_DOCK_ITEM_BEH_NEVER_FLOATING] and @[GNOME_DOCK_ITEM_BEH_NEVER_HORIZONTAL]
//! placement :  Placement for the new dock item, one of Gnome.DockTop,  Gnome.DockRight,  Gnome.DockBottom,  Gnome.DockLeft and  Gnome.DockFloating 
//! band_num : Number of the band where the dock item should be placed
//! band_position : Position of the new dock item in band band_num
//! offset : Offset from the previous dock item in the band; if there is no previous item, offset from the beginning of the band.
