...
GnomeEntry append_history( int save, string text );
...
static GnomeEntry create( string|void history_id );
...
GnomeEntry prepend_history( int save, string text );
...
GnomeEntry set_history_id( string|void history_id );
