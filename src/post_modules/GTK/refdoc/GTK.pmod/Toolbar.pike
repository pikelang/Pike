...
//! @[ORIENTATION_HORIZONTAL] and @[ORIENTATION_VERTICAL]. Style is one of @[TOOLBAR_ICONS], @[TOOLBAR_BOTH] and @[TOOLBAR_TEXT]
//!
//!
...
//! Set the style, one of @[TOOLBAR_ICONS], @[TOOLBAR_BOTH] and @[TOOLBAR_TEXT]
//!
//!
