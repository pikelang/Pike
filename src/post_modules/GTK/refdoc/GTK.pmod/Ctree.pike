...
int get_line_style( )
//! The style of the lines, one of @[CTREE_LINES_TABBED], @[CTREE_LINES_NONE], @[CTREE_LINES_SOLID] and @[CTREE_LINES_DOTTED]
//!
//!
...
//! Set the line style, one of @[CTREE_LINES_TABBED], @[CTREE_LINES_NONE], @[CTREE_LINES_SOLID] and @[CTREE_LINES_DOTTED]
//!
//!
