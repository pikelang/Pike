...
Window add_accel_group( GTK.AccelGroup group );
...
Window add_embedded_xid( int x_window_id );
//! Add an embedded X-window
//!
//!

static Window create( int window_type );
//! Argument is one of @[WINDOW_TOPLEVEL], @[WINDOW_DIALOG] and @[WINDOW_POPUP]
//!
//!
...
int get_type( );
//! The window type, one of @[WINDOW_TOPLEVEL], @[WINDOW_DIALOG] and @[WINDOW_POPUP]
//!
//!
...
Window remove_accel_group( GTK.AccelGroup table );
//! Remove a previously installed table.
//!
//!

Window remove_embedded_xid( int x_window_id );
//! Remove the embeded X window
//!
//!

Window set_default( GTK.Widget default_widget );
...
Window set_icon_name( string name );
//! Set the icon name to the specified string.
//!
//!

Window set_modal( int modalp );
//!/ Is this a modal dialog?
//!
//!

Window set_policy( int allow_shrink, int allow_grow, int auto_shrink );
...
Window set_position( int pos );
//! one of @[WIN_POS_CENTER], @[WINDOW_TOPLEVEL], @[WINDOW_DIALOG], @[WINDOW_POPUP], @[WIN_POS_NONE] and @[WIN_POS_MOUSE]
//!
//!

Window set_title( string title );
//! Set the window title. The default title is the value sent to
//! setup_gtk, or if none is sent, Pike GTK.
//!
//!

Window set_transient_for( GTK.Window parent );
...
Window set_wmclass( string name, string class );
