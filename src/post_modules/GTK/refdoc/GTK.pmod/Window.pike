...
//! Argument is one of @[WINDOW_TOPLEVEL], @[WINDOW_POPUP] and @[WINDOW_DIALOG]
//!
//!
...
int get_type( )
//! The window type, one of @[WINDOW_TOPLEVEL], @[WINDOW_POPUP] and @[WINDOW_DIALOG]
//!
//!
...
//! one of @[WIN_POS_CENTER], @[WIN_POS_MOUSE], @[WINDOW_TOPLEVEL], @[WINDOW_POPUP], @[WIN_POS_NONE] and @[WINDOW_DIALOG]
//!
//!
