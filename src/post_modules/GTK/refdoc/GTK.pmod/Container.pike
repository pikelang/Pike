...
//! Emulate a focus event. direction is one of @[DIR_RIGHT], @[DIR_LEFT], @[DIR_TAB_BACKWARD], @[DIR_DOWN], @[DIR_UP] and @[DIR_TAB_FORWARD].
//!
//!
...
//! One of @[RESIZE_QUEUE], @[RESIZE_PARENT] and @[RESIZE_IMMEDIATE]
//!
//!
