...
int get_action( )
//! One of @[GDK_ACTION_LINK], @[GDK_ACTION_MOVE], @[GDK_ACTION_DEFAULT], @[GDK_ACTION_COPY], @[GDK_ACTION_PRIVATE] and @[GDK_ACTION_ASK];
//!
//!

int get_actions( )
//! A bitwise or of one or more of @[GDK_ACTION_LINK], @[GDK_ACTION_MOVE], @[GDK_ACTION_DEFAULT], @[GDK_ACTION_COPY], @[GDK_ACTION_PRIVATE] and @[GDK_ACTION_ASK];
//!
//!
