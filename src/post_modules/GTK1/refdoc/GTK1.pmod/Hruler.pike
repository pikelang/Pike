...
//!
//!@expr{ GTK.Hruler()->set_metric(GTK.PIXELS)->set_range(0.0,100.0,50.0,100.0)->draw_ticks()->draw_pos()->set_usize(300,30)@}
//!@xml{<image>../images/gtk_hruler.png</image>@}
//!
//!@expr{ GTK.Hruler()->set_metric(GTK.CENTIMETERS)->set_range(0.0,100.0,50.0,100.0)->draw_ticks()->draw_pos()->set_usize(300,30)@}
//!@xml{<image>../images/gtk_hruler_2.png</image>@}
//!
//!@expr{ GTK.Hruler()->set_usize(300,30)@}
