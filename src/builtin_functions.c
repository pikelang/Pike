...
|| $Id: builtin_functions.c,v 1.474 2004/12/22 12:50:09 grubba Exp $
*/

#include "global.h"
RCSID("$Id: builtin_functions.c,v 1.474 2004/12/22 12:50:09 grubba Exp $");
#include "interpret.h"
#include "svalue.h"
...
PMOD_EXPORT void f_has_index(INT32 args)
{
  ...
  switch(Pike_sp[-2].type)
  {
    ...
    default:
      SIMPLE_BAD_ARG_ERROR ("has_index", 1,
...
PMOD_EXPORT void f_has_value(INT32 args)
{
  ...
  switch(Pike_sp[-2].type)
  {
    ...
    default:
      SIMPLE_BAD_ARG_ERROR ("has_value", 1, "string|array|mapping|object|program");
  }
}
