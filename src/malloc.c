...
PMOD_EXPORT void* dlmalloc(size_t bytes) {
  /*
     Basic algorithm:
...
PMOD_EXPORT void dlfree(void* mem) {
  /*
...
PMOD_EXPORT void* dlcalloc(size_t n_elements, size_t elem_size) {
  void* mem;
  size_t req = 0;
  if (n_elements != 0) {
...
PMOD_EXPORT void* dlrealloc(void* oldmem, size_t bytes) {
  if (oldmem == 0)
...
PMOD_EXPORT void* dlmemalign(size_t alignment, size_t bytes) {
...
PMOD_EXPORT void* dlvalloc(size_t bytes) {
  size_t pagesz;
  init_mparams();
...
PMOD_EXPORT void* dlpvalloc(size_t bytes) {
  size_t pagesz;
  init_mparams();
  pagesz = mparams.page_size;
