...
#include "../../../modules/Calendar.pmod/constants.h"
...
protected array(int) week_from_week(int y,int w);   // [y,w,wd,ndays,wjd]
protected array(int) week_from_julian_day(int jd);  // [y,w,wd,ndays,wjd]
