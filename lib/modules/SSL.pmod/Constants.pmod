...
enum Extension {
  ...
  EXTENSION_supported_skt_ciphers               = 39,   // RFC8446
  // 40 reserved tls-reg-review
  EXTENSION_pre_shared_key                      = 41,   // RFC8446
  EXTENSION_early_data				= 42,	// RFC8446
  EXTENSION_supported_versions                  = 43,   // RFC8446
  EXTENSION_cookie                              = 44,   // RFC8446
  EXTENSION_psk_key_exchange_modes              = 45,   // RFC8446
  // 46 reserved tls-reg-review
  EXTENSION_certificate_authorities             = 47,   // RFC8446
  EXTENSION_oid_filters                         = 48,   // RFC8446
  EXTENSION_post_handshake_auth                 = 49,   // RFC8446
  EXTENSION_signature_algorithms_cert           = 50,   // RFC8446
  EXTENSION_key_share                           = 51,   // RFC8446
  EXTENSION_transparency_info                   = 52,   // RFC9162
  EXTENSION_connection_id_deprecated            = 53,   // RFC9146
  EXTENSION_connection_id                       = 54,   // RFC9146
  EXTENSION_external_id_hash                    = 55,   // RFC8844
  EXTENSION_external_session_id                 = 56,   // RFC8844
  EXTENSION_quic_transport_parameters           = 57,   // RFC9001
  EXTENSION_ticket_request                      = 58,   // RFC9149
  EXTENSION_dnssec_chain                        = 59,   // RFC9102 / RFC 6860
  EXTENSION_grease_0a0a                         = 0x0a0a, // RFC8701
  EXTENSION_grease_1a1a                         = 0x1a1a, // RFC8701
  EXTENSION_grease_2a2a                         = 0x2a2a, // RFC8701
  EXTENSION_grease_3a3a                         = 0x3a3a, // RFC8701
  EXTENSION_grease_4a4a                         = 0x4a4a, // RFC8701
  EXTENSION_grease_5a5a                         = 0x5a5a, // RFC8701
  EXTENSION_grease_6a6a                         = 0x6a6a, // RFC8701
  EXTENSION_grease_7a7a                         = 0x7a7a, // RFC8701
  EXTENSION_grease_8a8a                         = 0x8a8a, // RFC8701
  EXTENSION_grease_9a9a                         = 0x9a9a, // RFC8701
  EXTENSION_grease_aaaa                         = 0xaaaa, // RFC8701
  EXTENSION_grease_baba                         = 0xbaba, // RFC8701
  EXTENSION_grease_caca                         = 0xcaca, // RFC8701
  EXTENSION_grease_dada                         = 0xdada, // RFC8701
  EXTENSION_grease_eaea                         = 0xeaea, // RFC8701
  EXTENSION_grease_fafa                         = 0xfafa, // RFC8701
