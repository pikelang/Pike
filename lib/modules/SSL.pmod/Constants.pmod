...
enum Extension {
  ...
  EXTENSION_token_binding                       = 24,   //! @rfc{8472@}
  EXTENSION_cached_info                         = 25,   //! @rfc{7924@}
  EXTENSION_tls_lts                             = 26,   //! draft-gutmann-tls-lts
  EXTENSION_compress_certificate                = 27,   //! @rfc{8879@}
  EXTENSION_record_size_limit                   = 28,   //! @rfc{8449@}
  EXTENSION_pwd_protect                         = 29,   //! @rfc{8492@}
  EXTENSION_pwd_clear                           = 30,   //! @rfc{8492@}
  EXTENSION_password_salt                       = 31,   //! @rfc{8492@}
  EXTENSION_ticket_pinning                      = 32,   //! @rfc{8672@}
  EXTENSION_tls_cert_with_extern_psk            = 33,   //! @rfc{8773@}
  EXTENSION_delegated_credential                = 34,   //! @rfc{9345@}
  EXTENSION_session_ticket			= 35,	//! @rfc{4507@} / @rfc{5077@}
  EXTENSION_TLMSP                               = 36,   //! ETSI TS 103 523-2
  EXTENSION_TLMSP_proxying                      = 37,   //! ETSI TS 103 523-2
  EXTENSION_TLMSP_delegate                      = 38,   //! ETSI TS 103 523-2
  EXTENSION_supported_skt_ciphers               = 39,   //! @rfc{8446@}
  // 40 reserved tls-reg-review
  // EXTENSION_key_share		        = 40,	//! TLS 1.3 draft.
  EXTENSION_pre_shared_key                      = 41,   //! @rfc{8446@}
  EXTENSION_early_data				= 42,	//! @rfc{8446@}
  EXTENSION_supported_versions                  = 43,   //! @rfc{8446@}
  EXTENSION_cookie                              = 44,   //! @rfc{8446@}
  EXTENSION_psk_key_exchange_modes              = 45,   //! @rfc{8446@}
  // 46 reserved tls-reg-review
  EXTENSION_certificate_authorities             = 47,   //! @rfc{8446@}
  EXTENSION_oid_filters                         = 48,   //! @rfc{8446@}
  EXTENSION_post_handshake_auth                 = 49,   //! @rfc{8446@}
  EXTENSION_signature_algorithms_cert           = 50,   //! @rfc{8446@}
  EXTENSION_key_share                           = 51,   //! @rfc{8446@}
  EXTENSION_transparency_info                   = 52,   //! @rfc{9162@}
  EXTENSION_connection_id_deprecated            = 53,   //! @rfc{9146@}
  EXTENSION_connection_id                       = 54,   //! @rfc{9146@}
  EXTENSION_external_id_hash                    = 55,   //! @rfc{8844@}
  EXTENSION_external_session_id                 = 56,   //! @rfc{8844@}
  EXTENSION_quic_transport_parameters           = 57,   //! @rfc{9001@}
  EXTENSION_ticket_request                      = 58,   //! @rfc{9149@}
  EXTENSION_dnssec_chain                        = 59,   //! @rfc{9102@} / @rfc{6860@}
  EXTENSION_grease_0a0a                         = 0x0a0a, //! @rfc{8701@}
  EXTENSION_grease_1a1a                         = 0x1a1a, //! @rfc{8701@}
  EXTENSION_grease_2a2a                         = 0x2a2a, //! @rfc{8701@}
  ...
  EXTENSION_grease_3a3a                         = 0x3a3a, //! @rfc{8701@}
  EXTENSION_grease_4a4a                         = 0x4a4a, //! @rfc{8701@}
  EXTENSION_grease_5a5a                         = 0x5a5a, //! @rfc{8701@}
  EXTENSION_grease_6a6a                         = 0x6a6a, //! @rfc{8701@}
  EXTENSION_channel_id				= 30031,
  EXTENSION_channel_id_new			= 30032,
  EXTENSION_grease_7a7a                         = 0x7a7a, //! @rfc{8701@}
  EXTENSION_grease_8a8a                         = 0x8a8a, //! @rfc{8701@}
  EXTENSION_old_padding				= 35655,
  EXTENSION_grease_9a9a                         = 0x9a9a, //! @rfc{8701@}
  EXTENSION_grease_aaaa                         = 0xaaaa, //! @rfc{8701@}
  EXTENSION_grease_baba                         = 0xbaba, //! @rfc{8701@}
  EXTENSION_grease_caca                         = 0xcaca, //! @rfc{8701@}
  EXTENSION_grease_dada                         = 0xdada, //! @rfc{8701@}
  EXTENSION_grease_eaea                         = 0xeaea, //! @rfc{8701@}
  EXTENSION_grease_fafa                         = 0xfafa, //! @rfc{8701@}
  EXTENSION_encrypted_client_hello              = 0xfe0d,//! draft-ietf-tls-esni-18
