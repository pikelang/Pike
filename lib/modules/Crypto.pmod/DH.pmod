...
class Parameters
{
  ...
  //!   @endarray
  array(2: Gmp.mpz) generate_keypair(function(int(0..):string(8bit)) rnd)
  {
  ...
  // Dummy declaration of Crypto.DSA.State to
  // avoid circular references.
  private class DSA_State {
    Gmp.mpz get_p();
    Gmp.mpz get_g();
    Gmp.mpz get_q();
  }
  ...
  //! @param dsa
  //!   Copy the parameters from this object.
  protected variant void create(DSA_State dsa)
  {
    p = dsa->get_p();
    g = dsa->get_g();
    q = dsa->get_q();
