...
([
   ...
   "Europe":    ({"Belfast", "Guernsey", "Isle_of_Man", "Jersey", "Ljubljana",
                  ...
                  "Zaporozhye"}),
   "Africa":    ({"Algiers", "Ndjamena", "Abidjan", "Djibouti", "Cairo",
                  "Asmara", "Addis_Ababa", "Accra", "Bissau", "Nairobi",
                  "Monrovia", "Tripoli", "Casablanca", "El_Aaiun", "Maputo",
                  "Windhoek", "Lagos", "Mogadishu", "Johannesburg",
                  "Khartoum", "Dar_es_Salaam", "Tunis", "Kampala", "Bamako",
                  "Bangui", "Banjul", "Blantyre", "Brazzaville", "Bujumbura",
                  "Conakry", "Dakar", "Douala", "Freetown", "Gaborone",
                  "Harare", "Juba", "Kigali", "Kinshasa", "Libreville",
                  "Lome", "Luanda", "Lubumbashi", "Lusaka", "Malabo",
