...
([
   "America":   ({"Adak", "Anchorage", "Anguilla", "Antigua", "Araguaina",
                  ...
                  "El_Salvador", "Ensenada", "Fortaleza", "Glace_Bay",
                  "Godthab", "Goose_Bay", "Grand_Turk", "Grenada",
                  ...
                  "Resolute", "Rio_Branco", "Rosario", "Santa_Isabel",
                  "Santarem", "Santiago", "Santo_Domingo", "Sao_Paulo",
                  "Scoresbysund", "Sitka", "St_Johns", "St_Kitts", "St_Lucia",
                  "St_Thomas", "St_Vincent", "Swift_Current", "Tegucigalpa",
   ...
   "Indian":    ({"Antananarivo", "Chagos", "Christmas", "Cocos", "Comoro",
                  ...
                  "Reunion"}),
   "Europe":    ({"Amsterdam", "Andorra", "Athens", "Belfast", "Belgrade",
                  "Berlin", "Brussels", "Bucharest", "Budapest", "Chisinau",
                  ...
                  "Malta", "Minsk", "Monaco", "Moscow", "Oslo", "Paris",
                  "Prague", "Riga", "Rome", "Samara", "Sarajevo",
                  "Simferopol", "Skopje", "Sofia", "Stockholm", "Tallinn",
                  "Tirane", "Tiraspol", "Uzhgorod", "Vaduz", "Vienna",
   ...
   "Asia":      ({"Aden", "Almaty", "Amman", "Anadyr", "Aqtau", "Aqtobe",
                  ...
                  "Beirut", "Bishkek", "Brunei", "Chita", "Choibalsan",
                  "Chongqing", "Colombo", "Damascus", "Dhaka", "Dili",
                  "Dubai", "Dushanbe", "Gaza", "Hanoi", "Harbin", "Hebron",
                  "Ho_Chi_Minh", "Hong_Kong", "Hovd", "Irkutsk", "Jakarta",
                  "Jayapura", "Jerusalem", "Kabul", "Kamchatka", "Karachi",
                  "Kashgar", "Kathmandu", "Khandyga", "Kolkata",
                  ...
                  "Pontianak", "Pyongyang", "Qatar", "Qyzylorda", "Rangoon",
                  "Riyadh", "Sakhalin", "Samarkand", "Seoul", "Shanghai",
                  "Singapore", "Srednekolymsk", "Taipei", "Tashkent",
                  "Tbilisi", "Tehran", "Tel_Aviv", "Thimphu", "Tokyo",
                  "Ulaanbaatar", "Urumqi", "Ust-Nera", "Vientiane",
...
([
   ...
   "AMT": ({"America/Boa_Vista", "America/Campo_Grande", "America/Cuiaba",
       ...
       "America/Eirunepe", "America/Rio_Branco", "America/Santarem",
   ...
   "EEST": ({"Africa/Cairo", "Asia/Amman", "Asia/Beirut", "Asia/Damascus",
       ...
       "Europe/Istanbul", "Europe/Kiev", "Europe/Riga", "Europe/Sofia",
   ...
   "LMT": ({"Asia/Aden", "Asia/Kuwait", "Asia/Thimphu", "Asia/Riyadh",
       ...
       "Asia/Srednekolymsk", "Asia/Anadyr", "Asia/Novokuznetsk",
       "America/Barbados", "Asia/Vladivostok", "Asia/Kamchatka",
       "Atlantic/Canary", "America/Ensenada", "America/Santa_Isabel",
       ...
       "Asia/Omsk", "Africa/Lagos", "Europe/Samara", "America/Guatemala",
       ...
       "America/Bogota", "America/Vancouver", "America/Dawson_Creek",
       "America/Creston", "America/Coral_Harbour", "America/Montreal",
       "America/Goose_Bay", "America/Blanc-Sablon", "America/St_Johns",
       "Atlantic/Azores", "Atlantic/Madeira", "Europe/Ljubljana",
       "Europe/Zagreb", "Europe/Sarajevo", "Europe/Belgrade",
       "Europe/Skopje", "America/Moncton", "America/Boise",
   ...
   "MAGST": ({"Asia/Magadan", "Asia/Srednekolymsk", "Asia/Ust-Nera"}),
   "MAGT": ({"Asia/Magadan", "Asia/Srednekolymsk", "Asia/Ust-Nera"}),
   ...
   "MPT": ({"America/Boise", "America/Cambridge_Bay", "America/Denver",
       ...
       "America/North_Dakota/New_Salem", "America/Phoenix", "America/Regina",
       "America/Swift_Current"}),
   "MSD": ({"Europe/Tiraspol", "Europe/Moscow", "Europe/Volgograd",
       "Europe/Simferopol", "Europe/Kaliningrad", "Europe/Samara",
   ...
   "NOVT": ({"Asia/Novosibirsk", "Asia/Novokuznetsk"}),
   ...
   "SAMT": ({"Europe/Samara", "Asia/Samarkand"}),
   ...
   "VET": ({"America/Caracas"}),
   "VLAST": ({"Asia/Khandyga", "Asia/Vladivostok"}),
   "VLAT": ({"Asia/Ust-Nera", "Asia/Vladivostok", "Asia/Khandyga"}),
   ...
   "WSST": ({"Pacific/Apia"}),
   "XJT": ({"Asia/Urumqi"}),
   "YAKST": ({"Asia/Chita", "Asia/Yakutsk", "Asia/Khandyga"}),
   "YAKT": ({"Asia/Khandyga", "Asia/Yakutsk", "Asia/Chita", "Asia/Ust-Nera"}),
