...
([
   "America":   ({"Danmarkshavn","Scoresbysund","Godthab","Thule","New_York",
                  ...
                  "Sitka","Metlakatla","Yakutat","Anchorage","Nome","Adak",
                  "Phoenix","Boise","Indiana/Indianapolis","Indiana/Marengo",
                  "Indiana/Vincennes","Indiana/Tell_City","Indiana/Petersburg",
                  "Indiana/Knox","Indiana/Winamac","Indiana/Vevay",           
                  "Kentucky/Louisville","Kentucky/Monticello","Detroit",      
                  "Menominee","St_Johns","Goose_Bay","Halifax","Glace_Bay", 
                  "Moncton","Blanc-Sablon","Montreal","Toronto",             
   ...
   "Atlantic":  ({"Cape_Verde","St_Helena","Faroe","Reykjavik","Azores",    
                  "Madeira","Canary","Bermuda","Stanley","South_Georgia"}), 
   ...
   "Europe":    ({"London","Dublin","Tirane","Andorra","Vienna","Minsk",   
                  ...
                  "Budapest","Rome","Riga","Vaduz","Vilnius","Luxembourg", 
                  "Malta","Chisinau","Monaco","Amsterdam","Oslo","Warsaw", 
                  "Lisbon","Bucharest","Kaliningrad","Moscow","Volgograd",  
                  "Samara","Belgrade","Madrid","Stockholm","Zurich",        
                  "Istanbul","Kiev","Uzhgorod","Zaporozhye","Simferopol"}), 
   "Africa":    ({"Algiers","Luanda","Porto-Novo","Gaborone","Ouagadougou", 
                  ...
                  "Malabo","Asmara","Addis_Ababa","Libreville","Banjul",    
                  "Accra","Conakry","Bissau","Nairobi","Maseru","Monrovia",
                  "Tripoli","Blantyre","Bamako","Nouakchott","Casablanca",  
                  "El_Aaiun","Maputo","Windhoek","Niamey","Lagos","Kigali",
                  "Sao_Tome","Dakar","Freetown","Mogadishu","Johannesburg", 
   ...
   "Asia":      ({"Kabul","Yerevan","Baku","Bahrain","Dhaka","Thimphu",    
                  ...
                  "Jerusalem","Tokyo","Amman","Almaty","Qyzylorda","Aqtobe",
                  "Aqtau","Oral","Bishkek","Seoul","Pyongyang","Kuwait",   
                  "Vientiane","Beirut","Kuala_Lumpur","Kuching","Hovd",     
                  "Ulaanbaatar","Choibalsan","Kathmandu","Muscat","Karachi",
                  "Gaza","Manila","Qatar","Riyadh","Singapore","Colombo",  
                  "Damascus","Dushanbe","Bangkok","Ashgabat","Dubai",       
                  "Samarkand","Tashkent","Ho_Chi_Minh","Aden",               
                  "Yekaterinburg","Omsk","Novosibirsk","Novokuznetsk",       
                  "Krasnoyarsk","Irkutsk","Yakutsk","Vladivostok","Sakhalin",
...
([
   ...
   "MET": ({"Europe/Tirane", "Europe/Andorra", "Europe/Vienna", "Europe/Minsk",
       "Europe/Brussels", "Europe/Sofia", "Europe/Prague",
       "Europe/Copenhagen", "Europe/Tallinn", "Europe/Berlin",
       "Europe/Gibraltar", "Europe/Athens", "Europe/Budapest",
       "Europe/Rome", "Europe/Riga", "Europe/Vaduz", "Europe/Vilnius",
   ...
   "NFT": ({"Europe/Paris", "Europe/Oslo", "Pacific/Norfolk"}),
   "NMT": ({"Pacific/Norfolk"}),
