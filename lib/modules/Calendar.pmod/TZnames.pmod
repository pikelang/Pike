...
([
   "America":   ({"Anguilla", "Antigua", "Argentina/ComodRivadavia", "Aruba",
                  ...
                  "Guadeloupe", "Montreal", "Montserrat", "Rosario",
                  "St_Kitts", "St_Lucia", "St_Thomas", "St_Vincent",
                  "Tortola", "Danmarkshavn", "Scoresbysund", "Godthab",
                  "Thule", "New_York", "Chicago", "North_Dakota/Center",
                  ...
                  "Tijuana", "Santa_Isabel", "Nassau", "Barbados", "Belize",
                  "Cayman", "Costa_Rica", "Havana", "Santo_Domingo",
                  "El_Salvador", "Guatemala", "Port-au-Prince", "Tegucigalpa",
                  "Jamaica", "Martinique", "Managua", "Panama", "Puerto_Rico",
                  "Miquelon", "Grand_Turk", "Argentina/Buenos_Aires",
   ...
   "Asia":      ({"Kabul", "Yerevan", "Baku", "Dhaka", "Thimphu", "Brunei",
                  "Rangoon", "Shanghai", "Urumqi", "Hong_Kong", "Taipei",
