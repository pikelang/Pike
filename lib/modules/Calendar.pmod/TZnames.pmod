...
([
   ...
   "Africa":    ({"Algiers", "Ndjamena", "Abidjan", "Cairo", "Accra",
                  ...
                  "Khartoum", "Juba", "Tunis", "Addis_Ababa", "Asmara",
                  "Bamako", "Bangui", "Banjul", "Blantyre", "Brazzaville",
                  "Bujumbura", "Conakry", "Dakar", "Dar_es_Salaam",
                  "Djibouti", "Douala", "Freetown", "Gaborone", "Harare",
                  "Kampala", "Kigali", "Kinshasa", "Libreville", "Lome",
                  "Luanda", "Lubumbashi", "Lusaka", "Malabo", "Maseru",
                  "Mbabane", "Mogadishu", "Niamey", "Nouakchott",
                  "Ouagadougou", "Porto-Novo", "Sao_Tome", "Timbuktu",
                  "Ceuta"}),
...
([
   ...
   "LMT": ({"Asia/Aden", "Asia/Kuwait", "Asia/Thimphu", "Asia/Riyadh",
       ...
       "Africa/Douala", "Africa/Luanda", "Africa/Ndjamena",
