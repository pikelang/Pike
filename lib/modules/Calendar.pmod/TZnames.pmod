...
([
   ...
   "Europe":    ({"London", "Dublin", "Tirane", "Andorra", "Vienna", "Minsk",
                  ...
                  "Volgograd", "Samara", "Belgrade", "Madrid", "Stockholm",
   ...
   "Africa":    ({"Algiers", "Luanda", "Porto-Novo", "Gaborone",
                  ...
                  "Khartoum", "Mbabane", "Dar_es_Salaam", "Lome", "Tunis",
                  "Kampala", "Lusaka", "Harare", "Ceuta"}),
   "Asia":      ({"Kabul", "Yerevan", "Baku", "Bahrain", "Dhaka", "Thimphu",
                  ...
                  "Vladivostok", "Khandyga", "Sakhalin", "Magadan",
...
([
   ...
   "BMT": ({"Africa/Banjul", "America/Barbados", "Europe/Bucharest",
       "Europe/Chisinau", "Asia/Jakarta", "Asia/Bangkok", "Asia/Baghdad",
       "America/Bogota", "Europe/Zurich", "Europe/Brussels"}),
   "BNT": ({"Asia/Brunei"}),
   "BORT": ({"Asia/Kuching"}),
   "BORTST": ({"Asia/Kuching"}),
   "BOST": ({"America/La_Paz"}),
   ...
   "EEST": ({"Africa/Cairo", "Asia/Amman", "Asia/Beirut", "Asia/Damascus",
       ...
       "Europe/Moscow", "Europe/Simferopol", "Europe/Warsaw"}),
   ...
   "LMT": ({"Pacific/Chatham", "Asia/Aden", "Asia/Riyadh", "Asia/Kuwait",
       ...
       "Asia/Khandyga", "Asia/Ust-Nera", "Asia/Novosibirsk", "Asia/Omsk",
       "Africa/Lagos", "Asia/Yekaterinburg", "Europe/Samara",
       ...
       "Pacific/Efate", "Africa/Dakar", "Africa/Banjul", "Africa/Nouakchott",
       ...
       "Europe/Malta", "Africa/Mogadishu", "Europe/Berlin", "Europe/Vienna",
       ...
       "America/Martinique", "Atlantic/Stanley", "America/Asuncion",
       ...
       "Pacific/Auckland", "Asia/Jakarta", "Europe/Rome", "Europe/Zurich",
   ...
   "MAGMT": ({"Asia/Magadan", "Asia/Ust-Nera"}),
   "MAGST": ({"Asia/Magadan", "Asia/Ust-Nera"}),
   "MAGT": ({"Asia/Magadan", "Asia/Ust-Nera"}),
   ...
   "MSK": ({"Europe/Moscow", "Europe/Simferopol", "Europe/Kaliningrad",
       "Europe/Minsk", "Europe/Vilnius", "Europe/Uzhgorod",
   ...
   "VLAMT": ({"Asia/Khandyga", "Asia/Vladivostok"}),
   ...
   "YAKMT": ({"Asia/Yakutsk", "Asia/Khandyga"}),
   "YAKST": ({"Asia/Yakutsk", "Asia/Khandyga"}),
   "YAKT": ({"Asia/Khandyga", "Asia/Yakutsk", "Asia/Ust-Nera"}),
