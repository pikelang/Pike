...
([
   ...
   "-02": ({"America/Araguaina", "America/Argentina/Buenos_Aires",
       ...
       "America/Noronha", "America/Nuuk", "America/Paramaribo",
       "America/Punta_Arenas", "America/Recife", "America/Santarem",
       "America/Sao_Paulo", "America/Scoresbysund", "Antarctica/Palmer",
       "Antarctica/Rothera", "Atlantic/South_Georgia", "Atlantic/Stanley",
       "Etc/GMT+2", "Etc/GMT+3", "America/Guyana", "America/Danmarkshavn",
       "Atlantic/Cape_Verde", "America/Argentina/ComodRivadavia",
       "America/Rosario", "Atlantic/Azores"}),
   ...
   "-03": ({"America/Araguaina", "America/Argentina/Buenos_Aires",
       ...
       "America/Cayenne", "America/Cuiaba", "America/Fortaleza",
       "America/Guyana", "America/La_Paz", "America/Maceio",
       "America/Manaus", "America/Miquelon", "America/Montevideo",
       "America/Paramaribo", "America/Porto_Velho", "America/Punta_Arenas",
       "America/Recife", "America/Rosario", "America/Santarem",
       "America/Santiago", "America/Sao_Paulo", "Antarctica/Palmer",
       "Antarctica/Rothera", "Atlantic/Stanley", "Etc/GMT+3", "Etc/GMT+4",
       "America/Nuuk", "America/Eirunepe", "America/Rio_Branco",
   ...
   "-04": ({"America/Boa_Vista", "America/Bogota", "America/Campo_Grande",
       ...
       "America/Argentina/Buenos_Aires", "America/Punta_Arenas",
       "America/Rosario", "Antarctica/Palmer", "Atlantic/Stanley",
       "America/Cayenne", "America/Montevideo"}),
   ...
   "-05": ({"America/Bogota", "America/Eirunepe", "America/Guayaquil",
       ...
       "Pacific/Easter", "Pacific/Galapagos", "America/Punta_Arenas",
       "America/Santiago"}),
   "-0530": ({"America/Belize"}),
   ...
   "C%sT": ({"America/Rainy_River", "CST6CDT", "America/Atikokan",
       "America/Pangnirtung"}),
   ...
   "CDT": ({"America/Bahia_Banderas", "America/Belize", "America/Chicago",
       ...
       "America/Rainy_River"}),
   "CE%sT": ({"CET", "Europe/Amsterdam", "Europe/Copenhagen",
       "Europe/Ljubljana", "Europe/Luxembourg", "Europe/Monaco",
       "Europe/Oslo", "Europe/Sarajevo", "Europe/Skopje", "Europe/Stockholm",
   ...
   "CEST": ({"Africa/Ceuta", "Africa/Tunis", "Europe/Andorra",
   ...
   "CET": ({"Africa/Algiers", "Africa/Ceuta", "Africa/Tunis",
   ...
   "CST": ({"America/Bahia_Banderas", "America/Belize", "America/Chicago",
       ...
       "America/Winnipeg", "Asia/Chongqing", "Asia/Harbin", "Asia/Kashgar",
       "Asia/Macau", "Asia/Shanghai", "Asia/Taipei", "America/Ciudad_Juarez",
   ...
   "E%sT": ({"America/Montreal", "America/Nassau", "America/Nipigon",
       "America/Pangnirtung", "America/Thunder_Bay", "EST5EDT",
   ...
   "EDT": ({"America/Detroit", "America/Grand_Turk",
       ...
       "America/Port-au-Prince", "America/Toronto", "America/Cancun",
       "America/Indiana/Tell_City", "America/Jamaica", "America/Montreal",
       "America/Nassau", "America/Santo_Domingo", "America/Nipigon"}),
   "EE%sT": ({"EET", "Europe/Uzhgorod", "Europe/Zaporozhye",
       "Europe/Tiraspol"}),
   "EEST": ({"Africa/Cairo", "Asia/Beirut", "Asia/Famagusta", "Asia/Gaza",
       "Asia/Hebron", "Asia/Nicosia", "Europe/Athens", "Europe/Bucharest",
       "Europe/Chisinau", "Europe/Helsinki", "Europe/Kyiv", "Europe/Riga",
       "Europe/Sofia", "Europe/Tallinn", "Europe/Vilnius", "Asia/Amman",
       "Europe/Istanbul", "Europe/Kaliningrad", "Europe/Minsk",
       "Europe/Moscow", "Asia/Damascus", "Europe/Simferopol",
       "Europe/Tiraspol", "Europe/Warsaw"}),
   "EET": ({"Africa/Cairo", "Africa/Tripoli", "Asia/Beirut",
       "Asia/Famagusta", "Asia/Gaza", "Asia/Hebron", "Asia/Nicosia",
   ...
   "EPT": ({"America/Detroit", "America/Grand_Turk",
       ...
       "America/Indiana/Tell_City", "America/Jamaica", "America/Nassau",
   ...
   "EST": ({"America/Atikokan", "America/Cancun", "America/Cayman",
       ...
       "America/Port-au-Prince", "America/Toronto", "EST",
   ...
   "LST": ({"Europe/Riga"}),
   "M%sT": ({"America/Yellowknife", "MST7MDT"}),
   "MDST": ({"Europe/Moscow"}),
   "MDT": ({"America/Boise", "America/Cambridge_Bay",
       "America/Ciudad_Juarez", "America/Denver", "America/Edmonton",
       "America/Inuvik", "America/Mazatlan", "America/Bahia_Banderas",
       "America/Chihuahua", "America/Hermosillo", "America/Mexico_City",
       "America/Monterrey", "America/North_Dakota/Beulah",
       "America/North_Dakota/Center", "America/North_Dakota/New_Salem",
   ...
   "MPT": ({"America/Boise", "America/Cambridge_Bay",
       "America/Ciudad_Juarez", "America/Denver", "America/Edmonton",
       "America/Inuvik", "America/North_Dakota/Beulah",
       "America/North_Dakota/Center", "America/North_Dakota/New_Salem",
       "America/Ojinaga", "America/Phoenix", "America/Regina",
       "America/Swift_Current"}),
   ...
   "MST": ({"America/Boise", "America/Cambridge_Bay",
       ...
       "America/Bahia_Banderas", "America/Chihuahua", "America/Mexico_City",
       "America/Monterrey", "America/North_Dakota/Beulah",
       "America/North_Dakota/Center", "America/North_Dakota/New_Salem",
   ...
   "P%sT": ({"America/Ensenada", "PST8PDT"}),
   "PDT": ({"America/Los_Angeles", "America/Tijuana", "America/Vancouver",
       "Asia/Manila", "America/Boise", "America/Dawson",
   ...
   "PST": ({"America/Los_Angeles", "America/Tijuana", "America/Vancouver",
       "Asia/Manila", "America/Metlakatla", "America/Ensenada",
   ...
   "WAT": ({"Africa/Bangui", "Africa/Brazzaville", "Africa/Douala",
       ...
       "Africa/Lubumbashi"}),
   "WE%sT": ({"WET", "Europe/Luxembourg", "Europe/Monaco"}),
   ...
   "WEST": ({"Atlantic/Canary", "Atlantic/Faroe", "Atlantic/Madeira",
       "Europe/Lisbon", "Atlantic/Azores", "Africa/Algiers", "Africa/Ceuta",
       "Europe/Madrid", "Europe/Paris", "Europe/Brussels",
       "Europe/Luxembourg"}),
   "WET": ({"Atlantic/Canary", "Atlantic/Faroe", "Atlantic/Madeira",
       "Europe/Lisbon", "Atlantic/Azores", "Africa/Algiers", "Africa/Ceuta",
       "Europe/Madrid", "Europe/Paris", "Europe/Andorra", "Europe/Brussels",
       "Europe/Luxembourg"}),
