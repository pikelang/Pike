...
([
   "America":   ({"Adak", "Anchorage", "Anguilla", "Antigua", "Araguaina",
                  ...
                  "Rainy_River", "Rankin_Inlet", "Recife", "Regina",
                  "Resolute", "Rio_Branco", "Rosario", "Santarem", "Santiago",
                  "Santo_Domingo", "Sao_Paulo", "Scoresbysund", "Sitka",
                  "St_Johns", "St_Kitts", "St_Lucia", "St_Thomas",
   ...
   "Europe":    ({"Amsterdam", "Andorra", "Astrakhan", "Athens", "Belfast",
                  ...
                  "Rome", "Samara", "Sarajevo", "Simferopol", "Skopje",
                  "Sofia", "Stockholm", "Tallinn", "Tirane", "Tiraspol",
                  "Ulyanovsk", "Uzhgorod", "Vaduz", "Vienna", "Vilnius",
   ...
   "Asia":      ({"Aden", "Almaty", "Amman", "Anadyr", "Aqtau", "Aqtobe",
                  "Ashgabat", "Baghdad", "Bahrain", "Baku", "Bangkok",
                  "Barnaul", "Beirut", "Bishkek", "Brunei", "Chita",
                  "Choibalsan", "Chongqing", "Colombo", "Damascus", "Dhaka",
                  "Dili", "Dubai", "Dushanbe", "Gaza", "Hanoi", "Harbin",
                  "Hebron", "Ho_Chi_Minh", "Hong_Kong", "Hovd", "Irkutsk",
                  "Jakarta", "Jayapura", "Jerusalem", "Kabul", "Kamchatka",
                  "Karachi", "Kashgar", "Kathmandu", "Khandyga", "Kolkata",
                  "Krasnoyarsk", "Kuala_Lumpur", "Kuching", "Kuwait", "Macau",
                  "Magadan", "Makassar", "Manila", "Muscat", "Nicosia",
                  "Novokuznetsk", "Novosibirsk", "Omsk", "Oral", "Phnom_Penh",
                  "Pontianak", "Pyongyang", "Qatar", "Qyzylorda", "Riyadh",
...
([
   ...
   "+02": ({"Antarctica/Troll", "Etc/GMT-2", "Europe/Ulyanovsk",
       "Europe/Samara"}),
   "+03": ({"Antarctica/Syowa", "Etc/GMT-3", "Europe/Istanbul",
       "Europe/Kirov", "Europe/Minsk", "Europe/Volgograd",
   ...
   "+08": ({"Antarctica/Casey", "Asia/Irkutsk", "Etc/GMT-8", "Asia/Chita",
   ...
   "+11": ({"Asia/Magadan", "Asia/Sakhalin", "Asia/Srednekolymsk",
       "Etc/GMT-11", "Asia/Ust-Nera", "Asia/Vladivostok", "Antarctica/Casey",
       "Asia/Khandyga", "Asia/Anadyr", "Asia/Kamchatka"}),
   "+12": ({"Asia/Anadyr", "Asia/Kamchatka", "Etc/GMT-12", "Asia/Magadan",
       "Asia/Srednekolymsk", "Asia/Ust-Nera", "Asia/Sakhalin"}),
   "+13": ({"Etc/GMT-13", "Asia/Anadyr", "Asia/Kamchatka"}),
   "+14": ({"Etc/GMT-14", "Asia/Anadyr"}),
   ...
   "EEST": ({"Africa/Cairo", "Asia/Amman", "Asia/Beirut", "Asia/Damascus",
       ...
       "Europe/Moscow", "Europe/Simferopol", "Europe/Tiraspol",
       "Europe/Warsaw"}),
   ...
   "LMT": ({"Asia/Aden", "Asia/Kuwait", "Asia/Thimphu", "Asia/Riyadh",
       ...
       "Europe/Kirov", "Europe/Samara", "Europe/Ulyanovsk",
