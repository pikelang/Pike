...
class Barb
{
   ...
   protected array(array(string|int)) jd_year_periods(int jd)
   {
      ...
      switch (y)
      {
         case 1942:
            return ({({0           ,0         ,0    ,"S"   }),  // ?
                     ({FIXED(109)  ,18000     ,3600 ,"D"   }),  // Apr 19
                     ({FIXED(243)  ,21600     ,0    ,"S"   })});// Aug 31
         case 1943:
            return ({({0           ,0         ,0    ,"S"   }),
                     ({FIXED(122)  ,18000     ,3600 ,"D"   }),  // May 2
                     ({FIXED(248)  ,21600     ,0    ,"S"   })});// Sep 5
         case 1944:
            return ({({0           ,0         ,0    ,"S"   }),
                     ({FIXED(101)  ,18000     ,1800 ,""    }),  // Apr 10
                     ({FIXED(254)  ,21600     ,0    ,"S"   })});// Sep 10
         case 1977:
            return ({({0           ,0         ,0    ,"S"   }),
...
class Chile
{
   ...
   protected array(array(string|int)) jd_year_periods(int jd)
   {
      ...
      switch (y)
      {
         ...
         case 2022:
            return ({({0           ,0         ,3600 ,""    }),
                     ({LDAY (98,7) ,10800     ,0    ,""    }),  // Apr Sun>=2
                     ({LDAY (258,7),14400     ,3600 ,""    })});// Sep Sun>=9
         case 2019..2021:
         case 2023..:
            return ({({0           ,0         ,3600 ,""    }),
   ...
   protected array(array(string|int)) jd_year_periods(int jd)
   {
      ...
      switch (y)
      {
         ...
         case 2023..:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAYL(120,5),UO+0      ,3600 ,"S"   }),  // Apr lastFri
                     ({LDAYL(304,4),UO+82800  ,0    ,""    })});// Oct lastThu
      }
   }
}
   ...
   protected array(array(string|int)) jd_year_periods(int jd)
   {
      ...
      switch (y)
      {
         ...
         case 2019:
            return ({({0           ,0         ,3600 ,""    }),
                     ({LDAY (18,7) ,UO+7200   ,0    ,""    }),  // Jan Sun>=12
                     ({LDAY (318,7),UO+7200   ,3600 ,""    })});// Nov Sun>=8
         case 2020:
            return ({({0           ,0         ,3600 ,""    }),
                     ({LDAY (18,7) ,UO+7200   ,0    ,""    }),  // Jan Sun>=12
...
class Iran
{
   ...
   protected array(array(string|int)) jd_year_periods(int jd)
   {
      ...
      switch (y)
      {
         case 1910:
            return ({({0           ,0         ,0    ,""    }),  // ?
                     ({FIXED(1)    ,UO+0      ,0    ,""    })});// Jan 1
         case 1977:
            return ({({0           ,0         ,0    ,""    }),
                     ({FIXED(80)   ,UO+82800  ,3600 ,""    }),  // Mar 21
                     ({FIXED(293)  ,UO+82800  ,0    ,""    })});// Oct 20
         case 1978:
            return ({({0           ,0         ,0    ,""    }),
                     ({FIXED(83)   ,UO+86400  ,3600 ,""    }),  // Mar 24
...
class Jordan
{
   ...
   protected array(array(string|int)) jd_year_periods(int jd)
   {
      ...
      switch (y)
      {
         ...
         case 2022:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (59,4) ,UO+86400  ,3600 ,"S"   }),  // Feb lastThu
                     ({LDAY (304,5),UO+0      ,0    ,""    })});// Oct lastFri
         default: // ..1972 and 2023..
         case 1979..1984:
            return ({({0           ,0         ,0    ,""    })});
      }
   }
...
class Palestine
{
   ...
   protected array(array(string|int)) jd_year_periods(int jd)
   {
      ...
      switch (y)
      {
         ...
         case 2016..2018:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAYL(89,6) ,UO+3600   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({LDAYL(303,6),UO+0      ,0    ,""    })});// Oct Sat<=30
         case 2019:
            return ({({0           ,0         ,0    ,""    }),
                     ({FIXED(88)   ,UO+0      ,3600 ,"S"   }),  // Mar 29
                     ({LDAY (303,6),UO-3600   ,0    ,""    })});// Oct Sat<=30
         case 2020:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (90,6) ,UO+0      ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(298)  ,UO+0      ,0    ,""    })});// Oct 24
         case 2021:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+0      ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(302)  ,UO+0      ,0    ,""    })});// Oct 29
         case 2022:
            return ({({0           ,0         ,0    ,""    }),
         ...
         case 2024:
            return ({({0           ,0         ,0    ,""    }),
                     ({FIXED(111)  ,UO+7200   ,3600 ,"S"   }),  // Apr 20
                     ({LDAY (304,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2025:
            return ({({0           ,0         ,0    ,""    }),
                     ({FIXED(102)  ,UO+7200   ,3600 ,"S"   }),  // Apr 12
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2036:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (90,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(292)  ,UO+3600   ,0    ,""    })});// Oct 18
         case 2037:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(283)  ,UO+3600   ,0    ,""    })});// Oct 10
         case 2038:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(268)  ,UO+3600   ,0    ,""    })});// Sep 25
         case 2039:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(260)  ,UO+3600   ,0    ,""    })});// Sep 17
         case 2040:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (90,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(245)  ,UO+3600   ,0    ,""    }),  // Sep 1
                     ({FIXED(294)  ,UO+7200   ,3600 ,"S"   }),  // Oct 20
                     ({LDAY (304,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2041:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(236)  ,UO+3600   ,0    ,""    }),  // Aug 24
                     ({FIXED(278)  ,UO+7200   ,3600 ,"S"   }),  // Oct 5
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2042:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(228)  ,UO+3600   ,0    ,""    }),  // Aug 16
                     ({FIXED(270)  ,UO+7200   ,3600 ,"S"   }),  // Sep 27
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2043:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(213)  ,UO+3600   ,0    ,""    }),  // Aug 1
                     ({FIXED(262)  ,UO+7200   ,3600 ,"S"   }),  // Sep 19
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2044:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (90,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(205)  ,UO+3600   ,0    ,""    }),  // Jul 23
                     ({FIXED(247)  ,UO+7200   ,3600 ,"S"   }),  // Sep 3
                     ({LDAY (304,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2045:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(196)  ,UO+3600   ,0    ,""    }),  // Jul 15
                     ({FIXED(238)  ,UO+7200   ,3600 ,"S"   }),  // Aug 26
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2046:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(181)  ,UO+3600   ,0    ,""    }),  // Jun 30
                     ({FIXED(230)  ,UO+7200   ,3600 ,"S"   }),  // Aug 18
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2047:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(173)  ,UO+3600   ,0    ,""    }),  // Jun 22
                     ({FIXED(215)  ,UO+7200   ,3600 ,"S"   }),  // Aug 3
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2048:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (90,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(158)  ,UO+3600   ,0    ,""    }),  // Jun 6
                     ({FIXED(207)  ,UO+7200   ,3600 ,"S"   }),  // Jul 25
                     ({LDAY (304,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2049:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(149)  ,UO+3600   ,0    ,""    }),  // May 29
                     ({FIXED(191)  ,UO+7200   ,3600 ,"S"   }),  // Jul 10
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2050:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(141)  ,UO+3600   ,0    ,""    }),  // May 21
                     ({FIXED(183)  ,UO+7200   ,3600 ,"S"   }),  // Jul 2
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2051:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(126)  ,UO+3600   ,0    ,""    }),  // May 6
                     ({FIXED(175)  ,UO+7200   ,3600 ,"S"   }),  // Jun 24
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2052:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (90,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(118)  ,UO+3600   ,0    ,""    }),  // Apr 27
                     ({FIXED(160)  ,UO+7200   ,3600 ,"S"   }),  // Jun 8
                     ({LDAY (304,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2053:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(102)  ,UO+3600   ,0    ,""    }),  // Apr 12
                     ({FIXED(151)  ,UO+7200   ,3600 ,"S"   }),  // May 31
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2054:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(94)   ,UO+3600   ,0    ,""    }),  // Apr 4
                     ({FIXED(143)  ,UO+7200   ,3600 ,"S"   }),  // May 23
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2055:
            return ({({0           ,0         ,0    ,""    }),
                     ({FIXED(128)  ,UO+7200   ,3600 ,"S"   }),  // May 8
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2023:
         case 2056:
            return ({({0           ,0         ,0    ,""    }),
                     ({FIX_L(119)  ,UO+7200   ,3600 ,"S"   }),  // Apr 29
                     ({LDAYL(303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2057:
            return ({({0           ,0         ,0    ,""    }),
                     ({FIXED(104)  ,UO+7200   ,3600 ,"S"   }),  // Apr 14
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         ...
         case 2072:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (90,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(254)  ,UO+3600   ,0    ,""    }),  // Sep 10
                     ({FIXED(296)  ,UO+7200   ,3600 ,"S"   }),  // Oct 22
                     ({LDAY (304,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2073:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(245)  ,UO+3600   ,0    ,""    }),  // Sep 2
                     ({FIXED(287)  ,UO+7200   ,3600 ,"S"   }),  // Oct 14
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2074:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(230)  ,UO+3600   ,0    ,""    }),  // Aug 18
                     ({FIXED(279)  ,UO+7200   ,3600 ,"S"   }),  // Oct 6
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2075:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(222)  ,UO+3600   ,0    ,""    }),  // Aug 10
                     ({FIXED(264)  ,UO+7200   ,3600 ,"S"   }),  // Sep 21
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2076:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (90,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(207)  ,UO+3600   ,0    ,""    }),  // Jul 25
                     ({FIXED(256)  ,UO+7200   ,3600 ,"S"   }),  // Sep 12
                     ({LDAY (304,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2077:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(198)  ,UO+3600   ,0    ,""    }),  // Jul 17
                     ({FIXED(247)  ,UO+7200   ,3600 ,"S"   }),  // Sep 4
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2078:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(190)  ,UO+3600   ,0    ,""    }),  // Jul 9
                     ({FIXED(232)  ,UO+7200   ,3600 ,"S"   }),  // Aug 20
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2079:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(175)  ,UO+3600   ,0    ,""    }),  // Jun 24
                     ({FIXED(224)  ,UO+7200   ,3600 ,"S"   }),  // Aug 12
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2080:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (90,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(167)  ,UO+3600   ,0    ,""    }),  // Jun 15
                     ({FIXED(209)  ,UO+7200   ,3600 ,"S"   }),  // Jul 27
                     ({LDAY (304,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2081:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(158)  ,UO+3600   ,0    ,""    }),  // Jun 7
                     ({FIXED(200)  ,UO+7200   ,3600 ,"S"   }),  // Jul 19
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2082:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(143)  ,UO+3600   ,0    ,""    }),  // May 23
                     ({FIXED(192)  ,UO+7200   ,3600 ,"S"   }),  // Jul 11
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2083:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(135)  ,UO+3600   ,0    ,""    }),  // May 15
                     ({FIXED(177)  ,UO+7200   ,3600 ,"S"   }),  // Jun 26
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2084:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (90,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(120)  ,UO+3600   ,0    ,""    }),  // Apr 29
                     ({FIXED(169)  ,UO+7200   ,3600 ,"S"   }),  // Jun 17
                     ({LDAY (304,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2085:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(111)  ,UO+3600   ,0    ,""    }),  // Apr 21
                     ({FIXED(160)  ,UO+7200   ,3600 ,"S"   }),  // Jun 9
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2086:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAY (89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({FIXED(103)  ,UO+3600   ,0    ,""    }),  // Apr 13
                     ({FIXED(145)  ,UO+7200   ,3600 ,"S"   }),  // May 25
                     ({LDAY (303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
         case 2026..2035:
         case 2059..2067:
         case 2087..:
            return ({({0           ,0         ,0    ,""    }),
                     ({LDAYL(89,6) ,UO+7200   ,3600 ,"S"   }),  // Mar Sat<=30
                     ({LDAYL(303,6),UO+3600   ,0    ,""    })});// Oct Sat<=30
      }
   }
}
...
class SL
{
   ...
   protected array(array(string|int)) jd_year_periods(int jd)
   {
      ...
      switch (y)
      {
         ...
         case 1932:
            return ({({0           ,0         ,0    ,"-01" }),  // ?
                     ({FIXED(336)  ,UO+0      ,1200 ,"-0040"})});// Dec 1
         case 1933..1938:
            return ({({0           ,0         ,1200 ,"-0040"}),
                     ({FIX_L(90)   ,UO+85200  ,0    ,"-01" }),  // Mar 31
                     ({FIX_L(243)  ,UO+86400  ,1200 ,"-0040"})});// Aug 31
         case 1939:
            return ({({0           ,0         ,1200 ,"-0040"}),
                     ({FIXED(151)  ,UO+85200  ,0    ,"-01" }),  // May 31
                     ({FIXED(243)  ,UO+86400  ,1200 ,"-0040"})});// Aug 31
         case 1940..:
            return ({({0           ,0         ,1200 ,"-0040"})});
      }
   }
...
class WS
{
   ...
   protected array(array(string|int)) jd_year_periods(int jd)
   {
      ...
      switch (y)
      {
         ...
         case 2021:
            return ({({0           ,0         ,3600 ,""    }),
                     ({LDAY (97,7) ,UO+10800  ,0    ,""    })});// Apr Sun>=1
         default: // ..2009 and 2022..
            return ({({0           ,0         ,0    ,""    })});
      }
   }
}
